 ...
 * Generated for Laravel 5.6.24 on 2018-06-08 10:46:45.
 *
...
namespace Botble\Assets\Facades { 
    ...
    class AssetsFacade {
         ...
         * @static 
         */ 
        public static function getJavascriptItemToHtml($name, $version = true)
        {
            return \Botble\Assets\Assets::getJavascriptItemToHtml($name, $version);
        }
         ...
         * @static 
         */ 
        public static function getStylesheetItemToHtml($name, $version = true)
        {
            return \Botble\Assets\Assets::getStylesheetItemToHtml($name, $version);
        }
         ...
         * @static 
         */ 
        public static function getAppModuleItemToHtml($module)
        {
            return \Botble\Assets\Assets::getAppModuleItemToHtml($module);
        }
...
namespace Botble\Table\Facades { 
    ...
    class TableBuilderFacade {
        ...
        {
            return \Botble\Table\TableBuilder::create($tableClass);
        }
...
namespace Botble\Base\Facades { 
    ...
    class EmailHandlerFacade {
         ...
         * @static 
         */ 
        public static function send($content, $title, $args = array())
        {
    ...
    class MailVariableFacade {
        ...
        {
            return \Botble\Base\Supports\MailVariable::initVariable();
        }
        ...
        {
            return \Botble\Base\Supports\MailVariable::initVariableValues();
        }
        ...
        {
            return \Botble\Base\Supports\MailVariable::setModule($module);
        }
        ...
        {
            return \Botble\Base\Supports\MailVariable::addVariable($name, $description);
        }
        ...
        {
            return \Botble\Base\Supports\MailVariable::addVariables($variables);
        }
        ...
        {
            return \Botble\Base\Supports\MailVariable::getVariables($module);
        }
        ...
        {
            return \Botble\Base\Supports\MailVariable::setVariableValue($variable, $value);
        }
        ...
        {
            return \Botble\Base\Supports\MailVariable::setVariableValues($data);
        }
        ...
        {
            return \Botble\Base\Supports\MailVariable::getVariableValue($variable, $module, $default);
        }
         ...
         * @static 
         */ 
        public static function prepareData($content)
        {
            return \Botble\Base\Supports\MailVariable::prepareData($content);
        }
...
namespace Botble\Theme\Facades { 
    ...
    class ThemeFacade {
        ...
        {
            return \Botble\Theme\Theme::scope($view, $args, $default);
        }
...
namespace  { 
    ...
    class TableBuilder extends \Botble\Table\Facades\TableBuilderFacade {}
